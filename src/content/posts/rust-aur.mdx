...
description: "Package and release a Rust application through the Arch User Repository."
date: "2021-03-21 18:45:00"
---

import { Image } from "astro:assets";
import cuddlyFerris from "../../assets/images/cuddlyferris.png";
import archLinux from "../../assets/images/archlinux.png";
...
<table class="responsive">
  <tbody>
    <tr>
      <td><Image src={cuddlyFerris} alt="Rust Cuddly Ferris" width={400} /></td>
      <td><Image src={archLinux} alt="Arch Linux" width={400} /></td>
    </tr>
  </tbody>
</table>
