...
description: "A collection of Git aliases that make common version-control tasks quicker and easier."
date: "2020-12-21 21:00:00"
---

import { Image } from "astro:assets";
import gitXkcd from "../../assets/images/git-xkcd.png";
...
<Image src={gitXkcd} alt="XKCD comic 1597 about the difficulty of git" width={300} />
{/* Excerpt End */}
