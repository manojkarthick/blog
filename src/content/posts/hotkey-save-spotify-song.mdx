...
description: "Save the currently playing Spotify song with a keyboard shortcut powered by Hammerspoon."
date: "2022-01-29 13:45:00"
---

import { Image } from "astro:assets";
import hammerspoon from "../../assets/images/hammerspoon.png";
...
<table class="responsive">
  <tbody>
    <tr>
      <td width={395}><Image src={hammerspoon} alt="Hammerspoon" /></td>
      <td width={5}>+</td>
      <td width={395}><Image src={spotify} alt="Spotify" width={195} /></td>
    </tr>
  </tbody>
</table>
