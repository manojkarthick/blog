...
description: "Disconnect Bluetooth headphones automatically when a MacBook goes to sleep using Hammerspoon."
date: "2022-01-30 18:00:00"
---

import { Image } from "astro:assets";
import sonyWh1000Xm4 from "../../assets/images/sony-wh-1000xm4.jpg";
...
<Image src={sonyWh1000Xm4} alt="Sony WH1000XM4" />
