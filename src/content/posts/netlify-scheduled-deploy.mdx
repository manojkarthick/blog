...
description: "Rebuild and deploy a blog on a recurring schedule with Netlify Scheduled Functions."
date: "2022-02-21 02:00:00"
---

import { Image } from "astro:assets";
import netlifyScheduledFunction from "../../assets/images/netlify-scheduled-function.png";
import netlifyBuildHook from "../../assets/images/netlify-build-hook.png";
import netlifyEnvVars from "../../assets/images/netlify-env-vars.png";
import projectsLastUpdated from "../../assets/images/projects-last-updated.png";

> [!NOTE]
> This blog now runs on [Astro](https://astro.build/) and [Cloudflare Workers](https://workers.cloudflare.com/). GitHub cards fetch live data in the browser, so scheduled Netlify rebuilds are no longer needed.
...
<Image src={netlifyScheduledFunction} alt="Netlify Scheduled Functions" />
...
<Image src={netlifyBuildHook} alt="Netlify Build hooks" />
...
<Image src={netlifyEnvVars} alt="Netlify Environment Variables" />
...
<Image src={projectsLastUpdated} alt="Project Last updated time" />
