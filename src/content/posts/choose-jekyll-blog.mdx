...
description: "An overview of Jekyll and ten reasons it was a strong choice for a personal blog."
date: "2016-09-03"
---

import { Image } from "astro:assets";
import jekyllLogo from "../../assets/images/jekyll-logo-820x418.png";

> [!NOTE]
> The updated version of the blog now uses [Astro](https://astro.build/) and [Cloudflare](https://www.cloudflare.com/) for hosting!
...
<Image src={jekyllLogo} alt="Jekyll" />
